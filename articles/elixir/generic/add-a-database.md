...
Modify the config to use environment variables generated by Nanobox. For example, if you're using ecto as a database mapper, your configuration might look like this:
...
#### From Phoenix
Again, if you're using ecto, you might test by running migrations:
