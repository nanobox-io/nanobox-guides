...
Modify your `config/dev.esx` to use environment variables generated by Nanobox:
...
> IMPORTANT: You'll also need to make this change in your `config/test.esx` and `config/prod.esx` to connect to your database in those environments.
