...
For ember, you'll need to modify your `WIP` to connect your app:
...
#### Running your app
You can also test your connection by simply trying to run your app and see if it is able to connect. In ember we could run the following command:
