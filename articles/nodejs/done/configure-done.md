# Configure DoneJS for Production

## Setup a webserver
DoneJS runs best in production with a reverse-proxy setup. Let's configure nginx to serve static assets directly, handle compression, and proxy connections into done through node's builtin server.
...
http {
    ...
    server {
        ...
        try_files $uri/index.html $uri @done;
...
## Compile Assets
We can have done compile assets during the deploy process by adding an extra step:
...
* [Preview your App](/nodejs/done/preview-your-app)
* [Launch your App](/nodejs/done/launch-your-app)
* [Back to done overview](/nodejs/done)
