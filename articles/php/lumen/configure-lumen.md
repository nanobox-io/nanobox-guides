# Configure Lumen for Production
...
## Add Streaming Logs
if you want Lumen to stream logs to the nanobox dashboard we'll need to add a `log_watch` path to the boxfile:
...
You might also need certain directories to be shared among all lumen instances. We can do this easily with nanobox by adding a storage data component:
...
* [Preview your App](/php/lumen/preview-your-app)
* [Launch your App](/php/lumen/launch-your-app)
