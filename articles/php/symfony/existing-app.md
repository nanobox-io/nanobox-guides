# Starting with an Existing Symfony App

Part of what makes Nanobox so useful is you don't have to have PHP installed on your local machine to run PHP apps. This guide walks through getting an existing Symfony app up and running with Nanobox.

*If you don't have an existing Symfony project, the [Symfony from Scratch](/php/symfony/from-scratch) guide would be the best place to start.*
...
With your app running, you can access it at `symfony.nanobox.dev` in your browser of choice.

## Now What?
Now that you have Symfony running on Nanobox, what's next? Think about what else your application might need and hopefully the topics below will help you get started with the next steps of your development!
