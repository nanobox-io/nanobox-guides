...
# start our server
web.site:
  start: 'bundle exec ruby myapp.rb'
```
...
nanobox sim dns add sinatra.nanobox.sim

# deploy the ruby runtime into the sim environment
nanobox sim deploy
```

Visit the app from your favorite browser at: `sinatra.nanobox.sim:8080`
...
* [Back to sinatra overview](overview.html)
